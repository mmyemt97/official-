        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="myNavbar">
                ...
                <ul class="nav navbar-nav navbar-right">
                    <li><a href="quan-ly-san-pham.jsp">Sản Phẩm</a></li>
                    <li><a href="quan-ly-nhan-vien.jsp">Nhân Viên</a></li>
                    <li><a href="quan-ly-thanh-vien.jsp">Thành Viên</a></li>
                    <li><a href="quan-ly-don-hang.jsp">Đơn Hàng</a></li>
                    <li>
