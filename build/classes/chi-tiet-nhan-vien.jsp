...
<body>
        ...
        <div class="main">
                <div class="container">
                    <div class="thongtin">
                        <form action="#" method="POST" class="fMain">
                            <div class="tensp">
                            ...
                            <table class="table">
                                <tr>
                                    <th>Mã nhân viên:</th>
                                    <td>
                                        <input type="text" name="txtMaNhanVien" class="txtsp" id="txtsp" value="${chitiet.idnhan_vien}" disabled>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <th>Họ:</th>
                                    <td>
                                        <input type="text" name="txtHoNhanVien" class="txtsp" id="txtsp3" value="${chitiet.ho_nhan_vien}" disabled>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <th>Tên:</th>
                                    <td>
                                        <input type="text" name="txtTenNhanVien" class="txtsp" id="txtsp4" value="${chitiet.ten_nhan_vien}" disabled>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <th>Chức vụ:</th>
                                    <td>
                                        <select class="fchucvu" name="txtMaChucVu" value="${chitiet.ma_chuc_vu}">
	                                        	<!-- admin -->
